...
(define (get-nth-tuple n tuplu)
  (λ(f1 f2 f3) (define L (get-transformations n))
    (define M (map (λ(l) (cond [(= l 1) f1]
                               [(= l 2) f2]
                               [(= l 3) f3])) L))
    (apply-functional-transformations M tuplu)))
...
(define (get-nth-ppt-from-matrix-transformations n)
  ((get-nth-tuple n '(3 4 5)) (λ(tuplu) (multiply T1 tuplu)) (λ(tuplu) (multiply T2 tuplu)) (λ(tuplu) (multiply T3 tuplu))))
...
(define (get-nth-quadruple n)
  ((get-nth-tuple n '(1 1 2 3)) (λ(tuplu) (apply Q1 tuplu))
                                (λ(tuplu) (apply Q2 tuplu))
                                (λ(tuplu) (apply Q3 tuplu))))
